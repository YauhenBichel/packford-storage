...
public class GenericRsqlSpecBuilder<T> {
    ...
    public GenericRsqlSpecBuilder(Set<String> excludedFields) {
    ...
    public Specification<T> createSpecification(final ComparisonNode comparisonNode) {
        if (excludedFields != null && excludedFields.contains(comparisonNode.getSelector())) {
            throw new IllegalArgumentException(String.format("Field \"%s\" is not available for search", comparisonNode.getSelector()));
        }
